...
#define PIN_BUSY    CONFIG_TESTAPEN_EPAPER_BUSY_GPIO
#define PIN_RST     CONFIG_TESTAPEN_EPAPER_RST_GPIO
#define PIN_DC      CONFIG_TESTAPEN_EPAPER_DC_GPIO
#define PIN_CS      CONFIG_TESTAPEN_EPAPER_CS_GPIO
#define PIN_CLK     CONFIG_TESTAPEN_EPAPER_CLK_GPIO
#define PIN_DIN     CONFIG_TESTAPEN_EPAPER_DIN_GPIO
